...
* the world does have write permissions
* the world does have execute permissions
hacker@permissions~permission-tweaking-practice:~$ chmod u-r /challenge/pwn | chmod o-r /challenge/pwn
You set the correct permissions!
Round 3 of 8!
...
- the world doesn't have write permissions
- the world doesn't have execute permissions
hacker@permissions~permission-tweaking-practice:~$ chmod u-x /challenge/pwn | chmod o-x /challenge/pwn
You set the correct permissions!
Round 5 of 8!
...
- the world doesn't have write permissions
* the world does have execute permissions
hacker@permissions~permission-tweaking-practice:~$ chmod u+rx /challenge/pwn | chmod g+r /challenge/pwn
You set the correct permissions!
Round 8 of 8!
...
- the world doesn't have write permissions
- the world doesn't have execute permissions
hacker@permissions~permission-tweaking-practice:~$ chmod u-rx /challenge/pwn | chmod o-x /challenge/pwn
You set the correct permissions!
...
---------- 1 hacker hacker 58 Oct  1 15:15 /flag
hacker@permissions~permission-tweaking-practice:~$ chmod u+r /flag
hacker@permissions~permission-tweaking-practice:~$ cat /flag
pwn.college{ABNsUd9E4bImGzevU0OGRNmil47.dBTM2QDL5EzN0czW}
```
**Flag:** `pwn.college{ABNsUd9E4bImGzevU0OGRNmil47.dBTM2QDL5EzN0czW}`
## New Learning
## Reference
